...
migrate:
	${COMPOSE} run invoices python manage.py makemigrations
	${COMPOSE} run invoices python manage.py migrate

# Créer un superutilisateur Django
createsuperuser:
	${COMPOSE} run invoices python manage.py createsuperuser
